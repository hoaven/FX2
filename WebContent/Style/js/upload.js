    ...
    $.fn.UploadImg = function(o){
        ...
        function _compress(blob,file){
            ...
            img.onload = function(){
                ...
                ctx.drawImage(this, xpos - w / 2, ypos - h / 2);
                ...
                if( navigator.userAgent.match(/iphone/i) ) {
                    ...
                    mpImg.render(canvas, { maxWidth: w, maxHeight: h, quality: o.quality});
                    // mpImg.render(canvas, { maxWidth: w, maxHeight: h, quality: o.quality || 0.8, orientation: 10 });
