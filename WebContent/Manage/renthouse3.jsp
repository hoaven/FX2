...
<body>
									...
									<tbody>
										<c:forEach items="${rhs}" var="f">
											<tr>
												...
												<td><a
													href="${pageContext.request.contextPath }/Manage/picurl3.do?id=${f.id}"
				...
				<div class="modal-body">
					<form method="post" id="addrhform">
						<table class="table table-bordered">
							...
							<tr>
								<td>装修期：</td>
								<td><input type="text" name="zxdate" id="zxdate1" onkeyup="checkRate(this.id)"/>个月</td>
							</tr>
							<tr>
								<td>入住时间：</td>
				...
				<div class="modal-body">
					<form method="post">
						...
						<table class="table table-bordered">
							<tr>
								<td>类型：</td>
								<td><select name="sptype" id="sptype2">
										<option value="1">街铺</option>
										<option value="2">百货超市</option>
										<option value="3">专业市场</option>
										<option value="4">其他</option>
							...
							<tr>
								<td>装修期：</td>
								<td><input type="text" name="zxdate" id="zxdate2"/>个月</td>
							</tr>
							<tr>
								<td>目前经营：</td>
								<td><select name="shanpuwork" id="shanpuwork2">
										<option value="1">服装类</option>
										<option value="2">电器类</option>
										<option value="3">食品类</option>
										<option value="4">其他类</option>
							...
							<tr>
								<td>转手费：</td>
								<td><input type="text" name="transferfee" id="transferfee2"
									onkeyup="checkRate(this.id)" />元</td>
							</tr>
							<tr>
								<td>租金：</td>
	...
	<!-- fx2.js -->
	<script
		src="${pageContext.request.contextPath }/Manage/js/renthouse3.js"></script>
</body>
</html>