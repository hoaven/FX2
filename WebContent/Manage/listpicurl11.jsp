...
<body>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<input type="hidden" name="renthouseid" id="renthouseid"
								value="${renthouseid}" />
	...
	<div class="modal fade bs-example-modal-lg" id="addFx2Modal"
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button class="btn" data-dismiss="modal" aria-hidden="true">关闭</button>
					<button type="button" onclick="addpicurl()" class="btn btn-primary">添加</button>
				</div>
			</div>
		</div>
	</div>
	...
	<script src="${pageContext.request.contextPath }/Manage/js/picurl11.js"></script>
