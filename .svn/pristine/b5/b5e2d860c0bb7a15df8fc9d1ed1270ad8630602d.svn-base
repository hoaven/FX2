...
<body>
									...
									<tbody>
										<c:forEach items="${rhs}" var="f">
											<tr>
												...
												<td><a
													href="${pageContext.request.contextPath }/Manage/picurl1.do?id=${f.id}"
				...
				<div class="modal-body">
					<form method="post">
						...
						<table class="table table-bordered">
							...
							<tr>
								<td>户型：</td>
								<td><select name="aparttype" id="aparttype2">
							...
							<tr>
								<td>楼层：</td>
								<td>第<input type="text" name="floor"
									onkeyup="checkRate(this.id)" id="floor2" />层 ，共<input
									type="text" name="floorcount" onkeyup="checkRate(this.id)"
									id="floorcount2" />层
								</td>
							</tr>
							<tr>
								<td>配套设施：</td>
								<td><input type="checkbox" name="equitment1" value="1" />床铺
									<input type="checkbox" name="equitment1" value="2" />电视 <input
									type="checkbox" name="equitment1" value="3" />洗衣机 <input
									type="checkbox" name="equitment1" value="4" />空调 <input
									type="checkbox" name="equitment1" value="5" />冰箱 <input
									type="checkbox" name="equitment1" value="6" />热水器 <input
									type="checkbox" name="equitment1" value="7" />宽带 <input
									type="checkbox" name="equitment1" value="8" />厨卫</td>
							</tr>
							<tr>
								<td>装修情况：</td>
				...
				<div class="modal-body">
					<form method="post" id="addrhform">
						<table class="table table-bordered">
							...
							<tr>
								<td>户型：</td>
								<td><select name="aparttype" id="aparttype1">
										<option value="1">一室</option>
										<option value="2">一室一厅</option>
										<option value="3">一室两厅</option>
										<option value="4">一室一厅一卫</option>
							...
							<tr>
								<td>面积：</td>
								<td><input type="text" name="area" id="area1" onkeyup="checkRate(this.id)"/>平方米</td>
							</tr>
							<tr>
								<td>楼层：</td>
								<td>第<input type="text" name="floor"
									onkeyup="checkRate(this.id)" id="floor1" />层 ，共<input
									type="text" name="floorcount" onkeyup="checkRate(this.id)"
									id="floorcount1" />层
								</td>
							</tr>
							<tr>
								<td>配套设施：</td>
								<td><input type="checkbox" name="equitment" value="1" />床铺
									<input type="checkbox" name="equitment" value="2" />电视 <input
									type="checkbox" name="equitment" value="3" />洗衣机 <input
									type="checkbox" name="equitment" value="4" />空调 <input
									type="checkbox" name="equitment" value="5" />冰箱 <input
									type="checkbox" name="equitment" value="6" />热水器 <input
									type="checkbox" name="equitment" value="7" />宽带 <input
									type="checkbox" name="equitment" value="8" />厨卫</td>
							</tr>
							<tr>
								<td>装修情况：</td>
	...
	<!-- fx2.js -->
	<script
		src="${pageContext.request.contextPath }/Manage/js/renthouse1.js"></script>
</body>
</html>