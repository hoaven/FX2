...
<body>
									...
									<tbody>
										<c:forEach items="${rhs}" var="f">
											<tr>
												...
												<td><a
													href="${pageContext.request.contextPath }/Manage/picurl11.do?id=${f.id}"
	...
	<div class="modal fade bs-example-modal-lg" id="bdfx2Modal"
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form method="post">
						<input type="hidden" id="renthid" /> 选择蜂小二：<select id="fx2"
							size="5">
						</select>
					</form>
				</div>
				<div class="modal-footer">
					<button class="btn" data-dismiss="modal" aria-hidden="true">关闭</button>
					<button type="button" onclick="bdfx2ById()" class="btn btn-primary">绑定</button>
				</div>
			</div>
		</div>
	</div>
	...
	<!-- fx2.js -->
	<script
		src="${pageContext.request.contextPath }/Manage/js/renthouse11.js"></script>
</body>
</html>