...
jQuery.fn.rater	= function(options) {
	...
	var settings = {
		...
		title_format	: null,
		info_format	: null,
		image	: '../../Style/comment/images/comment/stars.jpg',
		imageAll :'../../Style/comment/images/comment/stars-all.gif',
		defaultTips :true,
		clickTips :true,
		width	: 24,
		height	: 24
...
$(function(){
	...
	title_format	: function(value) {
		...
		switch (value) {
			case 1 : 
				title	= '很不满意';
				document.getElementById("myscore").value=value;
				break;
			case 2 : 
				title	= '不满意';
				document.getElementById("myscore").value=value;
			...
			default :
				title = value;
				document.getElementById("myscore").value("1");
				break;
		}
		return title;
	},
